projects = [
    {
        ...
        img: 'img/other-projects/eye.png',
        popup: {
            link: 'https://mingrkli-spooky.netlify.app/',
            subDesc: "Eyeballs staring at your mouse while moving away of you get too close.",
        }
    },
    {
        ...
        popup: {
            ...
            subDesc: "Choose a sound file and watch the animations go with colorful lights.",
        }
    },
    {
    ...
    },
    {
        ...
        popup: {
            ...
            subDesc: "Move your mouse to see a colorful RGB trail of random letters, numbers, and japanese characters.",
        }
    },
    {
        title: 'Minnew News Site - Suggested by Jake',
        img: 'img/other-projects/minnew.png',
        popup: {
            link: 'https://mingrkli-minnew.netlify.app/',
            subDesc: "A cool 3d card feel news site",
        }
    },
    {
        title: "Jake's Best Day",
        img: 'img/other-projects/yoi.png',
        popup: {
            link: 'https://jake-best-day.netlify.app/',
            subDesc: "A site created for a buddy of mine as it's his best day ever.",
        }
    },
    {
        title: 'Mesco Shopping Site With Working Cart',
        img: 'img/other-projects/mesco.png',
        popup: {
    ...
    {
        title: "Peakalo's Diner - Suggested by Ace",
        img: 'img/other-projects/diner.png',
        popup: {
            link: 'https://peakalos-diner.netlify.app/',
            subDesc: "A restaurant with a menu when hover over names, shows the food image.",
        }
    },
    {
        ...
        popup: {
            ...
            subDesc: "A cool clock in which you can edit the colors.",
        }
    },
]